...
import { AppRegistry, Image,ImageBackground,StyleSheet, TextInput, View,Alert,ScrollView,FlatList, Button,Text ,TouchableOpacity,TouchableHighlight} from 'react-native';
      ...
      Color2:'grey',
        ...
        Color4:'grey',
          Color5:'grey',
            ...
            fontSize:20,
            enterfruitname:'',
            image:require('C:/Users/Shaheryar Nadeem/maps/src/assets/apple.jpg'),
...
toggleDisplay4() {
  // if (this.state.samplearray[1]=='banana') {
  //   this.setState({image:'C:/Users/Shaheryar Nadeem/maps/src/assets/apple.jpg'})
  //   alert("")
  // }
...
enter(){
  ...
  var text1=this.state.text;
   this.state.samplearray1.splice(i,i,text1)
   this.setState({text:''})
this.setState({samplearray:this.state.samplearray1})
}
 ...
 render() {
   ...
   return (
    ...
    <ImageBackground   source={this.state.image}style={styles.MainContainer} >
...
<Text style={{color: this.state.Color6,fontSize:this.state.fontSize}}>{this.state.samplearray} </Text>
       </View>
